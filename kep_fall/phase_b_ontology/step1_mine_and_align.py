...
DPV_BASE       = config.DPV_BASE
GROQ_API_KEY   = config.GROQ_API_KEY
CHUNKS_JSON    = config.CORPUS_CHUNKS
OUT_DIR        = config.ONTOLOGY_DIR
OUT_CANDIDATES = config.ONTO_CANDIDATES
OUT_ALIGNMENT  = config.ONTO_ALIGNMENT
OUT_ONTOLOGY   = config.ONTOLOGY_V1          # was dpv-fallrisk-ext.rdf
OUT_CLASSES    = config.ONTO_CLASSES
OUT_DEDUP      = config.ONTO_DEDUP_REPORT
OUT_LOG        = config.BUILD_LOGS_DIR / "phase_b_step1_mine_and_align.md"
