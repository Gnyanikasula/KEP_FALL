...
ALIGNMENT_JSON = config.ONTO_ALIGNMENT
CLASSES_JSON   = config.ONTO_CLASSES
OUT_RDF        = config.ONTOLOGY_V2
OUT_CLASSES_V2 = config.ONTO_CLASSES_V2
OUT_LOG        = config.BUILD_LOGS_DIR / "phase_b_step2_reparent.md"
