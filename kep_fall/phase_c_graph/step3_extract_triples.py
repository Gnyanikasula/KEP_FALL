...
ARTICLES_PATH   = config.ARTICLES_WITH_CLASSES
VOCAB_PATH      = config.VOCAB_INDEX
EMBED_NAME_PATH = config.CLASS_NAME_EMBEDDING
OUTPUT_PATH     = config.TRIPLES_RAW
CHECKPOINT_PATH = config.EXTRACTION_CHECKPOINT
WINDOW_WORDS    = 2000
OVERLAP_WORDS   = 150
MIN_CONFIDENCE  = 0.7
MAX_TRIPLES     = 12
