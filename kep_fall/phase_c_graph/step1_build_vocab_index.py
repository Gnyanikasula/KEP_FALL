...
RDF_PATH       = config.ONTOLOGY          # == ONTOLOGY_V4
VOCAB_OUT      = config.VOCAB_INDEX
EMBED_OUT      = config.CLASS_EMBEDDINGS
EMBED_NAME_OUT = config.CLASS_NAME_EMBEDDING
LOG_OUT        = config.BUILD_LOGS_DIR / "phase_c_step1_vocab_index.txt"
